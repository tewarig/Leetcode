...
<pre style="position: relative;"><strong>Input: </strong><span id="example-input-1-1">[1,2,3,4,5]</span>
...
<pre style="position: relative;"><strong>Input: </strong><span id="example-input-2-1">[1,2,3,4,5,6]</span>
